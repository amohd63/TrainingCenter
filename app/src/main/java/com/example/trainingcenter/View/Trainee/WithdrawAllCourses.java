...
public class WithdrawAllCourses extends AppCompatDialogFragment {
    private String email;
    private FirebaseFirestore db;
    AlertDialog dialog;
    private WithdrawDialog.WithdrawListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                collectionRef.whereEqualTo("traineeID", email)
                        .get()
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (WithdrawDialog.WithdrawListener) context;
